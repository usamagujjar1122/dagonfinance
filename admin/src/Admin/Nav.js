                            ...
                            >
                                <Paper sx={{ minWidth: '50vw', backgroundColor: '#375160', minHeight: '100%' }} onClick={() => setOpen(false)}>
                                    <Stack sx={{ gap: "20px", padding: '20px' }}>
                                        ...
                                        <Link to="kyc" style={{ textDecoration: 'none' }}><Typography sx={{ color: 'white', cursor: "pointer", fontWeight: "700", '&:hover': { color: '#e1c903', transform: 'translateY(-5px)' }, transition: 'transform 0.5s', fontSize: '14px', textTransform: "uppercase", whiteSpace: 'nowrap' }}>KYC</Typography></Link>
                                    </Stack>
                                </Paper>
                            </Drawer>
                            </Stack>
